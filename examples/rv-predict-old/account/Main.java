	...
	public static void main(String[] args) {
		...
		try{
			if(args.length>0){
				...
				System.out.println("The output file name is missing, using /dev/null");
                                out=new PrintStream(new FileOutputStream("/dev/null")); // Stop being boneheaded and just use /dev/null
			}
